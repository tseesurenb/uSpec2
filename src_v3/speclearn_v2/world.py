...
def print_config_summary():
    ...
    if config['verbose'] > 0:
        ...
        print(f"├─ Filter type: \033[94m{config['filter_type']}\033[0m")
        print(f"├─ Epochs: \033[94m{config['epochs']}\033[0m")
        print(f"└─ Seed: \033[94m{seed}\033[0m")
        
        print(f"\n🔧 \033[95mLearning Rates:\033[0m")
        print(f"├─ User: \033[93m{config.get('user_lr', 0.1)}\033[0m")
        print(f"├─ Item: \033[93m{config.get('item_lr', 0.01)}\033[0m")
        print(f"└─ Bipartite: \033[93m{config.get('bipartite_lr', 0.05)}\033[0m")
